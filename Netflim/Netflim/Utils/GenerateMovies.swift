...
//  Netflim
//
//  Created by Hiram Castro on 10/02/21.
//
...
func generateMovies(_ count: Int) -> [MovieModel] {
    ...
    for _ in 0..<count {
        ...
        let moreLikeThis = helper.movieLikeThisArray
        
        let movie = MovieModel(id: id,
                               name: name,
...
func generateTrailers(_ count: Int) -> [TrailerModel] {
    ...
    for _ in 0..<count {
        ...
        let trailer = TrailerModel(id: id, name: name, videoURL: helper.exampleVideoURL, thumbnailImageURL: thumbnail)
...
func generateEpisodes(_ count: Int, forSeason season: Int) -> [Episode] {
    ...
    for num in 0..<count {
        ...
        let episode = Episode(id: id,
                              ...
                              description: desc,
                              length: randLength,
                              videoURL: helper.exampleVideoURL)
